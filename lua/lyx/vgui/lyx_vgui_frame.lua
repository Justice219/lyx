...
function PANEL:CreateTopBar()
    ...
    close.Paint = function(self, w, h)
        surface.SetMaterial(lyx.Materials["Cross"])
...
concommand.Add("lyx_frame", function()
    ...
    frame.Navbar:AddButton("Player", lyx.Colors.Primary, lyx.Icons.Player, function(pnl)
        pnl:Clear()
    ...
    frame.Navbar:AddButton("Server", lyx.Colors.Primary, lyx.Icons.Server, function(pnl)
        pnl:Clear()
    ...
    frame.Navbar:AddButton("World", lyx.Colors.Primary, lyx.Icons.World, function(pnl)
        pnl:Clear()
    end)
