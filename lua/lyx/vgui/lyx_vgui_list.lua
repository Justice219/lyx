...
function PANEL:Setup()
        ...
        if self.ListRounded then
            self:Background(lyx.Colors.Primary, self.ListRoundedSize)
        else
            self:Background(lyx.Colors.Primary, 0)
        end

        if self.ShowListOutline then
            self:Outline(lyx.Colors.White, self.ListOutlineRadius)
        end
    ...
    for k,v in pairs(self.Items) do
        if v.Type == "checkbox" then
            ...
            container:ClearPaint()
                :Background(lyx.Colors.Secondary, 5)
            ...
            checkbox:TDLib()
            checkbox:ClearPaint()
                :CircleCheckbox(lyx.Colors.Green)
        ...
        elseif v.Type == "slider" then
            ...
            slider:TDLib()
            slider:ClearPaint()
                :Background(lyx.Colors.Primary, 5)
