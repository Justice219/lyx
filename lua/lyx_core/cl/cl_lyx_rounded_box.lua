...
do
    ...
    do
        ...
        drawRoundedBoxEx = function(borderSize, x, y, w, h, col, topLeft, topRight, bottomLeft, bottomRight)
            ...
            w = round(w)
            h = round(h)
            borderSize = min(round(borderSize), floor(w * 0.5))
    ...
    lyx.DrawRoundedBoxEx = drawRoundedBoxEx
    function lyx.DrawRoundedBox(borderSize, x, y, w, h, col)
        return drawRoundedBoxEx(borderSize, x, y, w, h, col, true, true, true, true)
    end
end

local drawFullRoundedBoxEx
do
    ...
    drawFullRoundedBoxEx = function(borderSize, x, y, w, h, col, tl, tr, bl, br)
        setDrawColor(col.r, col.g, col.b, col.a)
...
lyx.DrawFullRoundedBoxEx = drawFullRoundedBoxEx
function lyx.DrawFullRoundedBox(borderSize, x, y, w, h, col)
