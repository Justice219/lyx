...
function PANEL:OpenMenu(pControlOpener)
    ...
    CloseDermaMenus()
    self.Menu = vgui.Create("lyx.Menu2", self)
...
function PANEL:PaintOver(w, h)
    ...
    lyx.DrawImgur(w - dropBtnSize - lyx.Scale(8), h * 0.5 - dropBtnSize * 0.5, dropBtnSize, dropBtnSize, "30Bvuwi", lyx.Colors.PrimaryText)
end

vgui.Register("lyx.ComboBox2", PANEL, "lyx.TextButton2")