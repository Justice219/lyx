...
function PANEL:AddOption(strText, funcFunction)
    local pnl = vgui.Create("lyx.MenuOption2", self)
    pnl:SetMenu(self)
    pnl:SetText(strText)
...
function PANEL:AddCVar(strText, convar, on, off, funcFunction)
    local pnl = vgui.Create("lyx.MenuOptionCVar2", self)
    pnl:SetMenu(self)
    pnl:SetText(strText)
    if funcFunction then pnl.DoClick = funcFunction end
...
function PANEL:AddSpacer(text, func)
    ...
    local spacerCol = lyx.OffsetColor(lyx.Colors.Background, 6)
...
vgui.Register("lyx.Menu2", PANEL, "lyx.ScrollPanel2")