...
function PANEL:Init()
    self.NormalCol = lyx.Colors.Scroller
...
function PANEL:Paint(w, h)
    ...
    lyx.DrawRoundedBox(w * 0.5, 0, 0, w, h, self.Colour)
end

vgui.Register("lyx.ScrollbarGrip2", PANEL, "Panel")
...
function PANEL:Init()
    ...
    self.BackgroundCol = lyx.OffsetColor(lyx.Colors.Background, 5)

    self.Scrollbar = vgui.Create("lyx.ScrollbarGrip2", self)
...
function PANEL:Paint(w, h)
    lyx.DrawRoundedBox(w * 0.5, 0, 0, w, h, self.BackgroundCol)
end

vgui.Register("lyx.Scrollbar2", PANEL, "Panel")