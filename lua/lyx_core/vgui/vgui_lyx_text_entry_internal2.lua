...
lyx.RegisterFont("UI.TextEntry", "Open Sans SemiBold", 18)
...
function PANEL:Init()
    ...
    self:SetCursor("beam")
    self:SetFontInternal(lyx.GetRealFont("UI.TextEntry"))
end
...
function PANEL:Paint(w, h)
    self:DrawTextEntryText(color_white, lyx.Colors.Primary, lyx.Colors.Primary)
end
...
vgui.Register("lyx.TextEntryInternal2", PANEL, "TextEntry")