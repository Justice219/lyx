...
lyx.RegisterFont("UI.CategoryHeader", "Open Sans Bold", 19)

function PANEL:Init()
    self.ArrowRotation = 0

    self.BackgroundCol = lyx.OffsetColor(lyx.Colors.Background, 6)
end
...
function PANEL:Paint(w, h)
    ...
    lyx.DrawSimpleText(self.Title, "UI.CategoryHeader", lyx.Scale(10), h * 0.5, lyx.Colors.PrimaryText, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
...
function PANEL:Init()
    self.Header = vgui.Create("lyx.CategoryHeader2", self)

    self:SetTitle("lyx Category")
...
vgui.Register("lyx.Category2", PANEL, "Panel")