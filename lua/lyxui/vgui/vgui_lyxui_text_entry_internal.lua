--[[
	LYXUI Text Entry Internal Element
	Ported from PIXEL UI. Internal text entry used inside LYXUI.TextEntry wrapper.
]]
...
lyx.RegisterFont("LYXUI.TextEntry", "Open Sans SemiBold", 18)
...
function PANEL:Init()
    ...
    self:SetTall(lyx.Scale(34))

    self.m_bLoseFocusOnClickAway = true

    self:SetCursor("beam")
    self:SetFontInternal(lyx.GetRealFont("LYXUI.TextEntry"))
end
...
function PANEL:Paint(w, h)
    self:DrawTextEntryText(color_white, LYXUI.Colors.Primary, LYXUI.Colors.Primary)
end
...
vgui.Register("LYXUI.TextEntryInternal", PANEL, "TextEntry")
