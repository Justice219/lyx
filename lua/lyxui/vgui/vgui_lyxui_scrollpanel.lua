--[[
	LYXUI Scroll Panel Element
	Ported from PIXEL UI. Scrollable container with momentum scrolling.
]]
...
function PANEL:Init()
    ...
    self.VBar = vgui.Create("LYXUI.Scrollbar", self)
...
vgui.Register("LYXUI.ScrollPanel", PANEL, "DPanel")
