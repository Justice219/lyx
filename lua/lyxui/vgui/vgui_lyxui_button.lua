--[[
	LYXUI Button Element
	Ported from PIXEL UI. Base button with toggle support and color animations.
]]
...
function PANEL:Init()
    ...
    self.NormalCol = lyx.CopyColor(LYXUI.Colors.Primary)
    self.HoverCol = lyx.OffsetColor(self.NormalCol, -15)
    self.ClickedCol = lyx.OffsetColor(self.NormalCol, 15)
    self.DisabledCol = lyx.CopyColor(LYXUI.Colors.Disabled)
...
vgui.Register("LYXUI.Button", PANEL, "Panel")
