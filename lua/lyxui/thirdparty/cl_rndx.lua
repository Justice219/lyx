--[[
	...
	RNDX Shader Library by Srlion (https://github.com/Srlion)
	MIT License

	Provides GPU-accelerated rounded box rendering via custom shaders.
	This library creates the RNDX global table with drawing functions
	for rounded rectangles, circles, outlines, shadows, and blur effects.
]]
...
-- @param r number Corner radius in pixels
-- @param x number X position
-- @param y number Y position
-- @param w number Width
-- @param h number Height
-- @param col Color Fill color
-- @param flags number Optional RNDX flags (shape, blur, etc.)
function RNDX.Draw(r, x, y, w, h, col, flags)
	draw_rounded(x, y, w, h, col, flags, r, r, r, r)
end

--- Draws a rounded rectangle with an outline (no fill)
...
-- @param texture ITexture The texture to apply
-- @param flags number Optional RNDX flags
function RNDX.DrawTexture(r, x, y, w, h, col, texture, flags)
	draw_rounded(x, y, w, h, col, flags, r, r, r, r, texture)
end

--- Draws a rounded rectangle with a material's base texture
-- @param r number Corner radius
-- @param x number X position
-- @param y number Y position
-- @param w number Width
-- @param h number Height
-- @param col Color Tint color
-- @param mat IMaterial The material whose $basetexture to use
-- @param flags number Optional RNDX flags
...
--- Draws a circle using the RNDX shader
-- @param x number Center X
-- @param y number Center Y
-- @param r number Radius (diameter = r)
-- @param col Color Fill color
-- @param flags number Optional RNDX flags
...
--- Draws a circle outline using the RNDX shader
-- @param x number Center X
-- @param y number Center Y
...
local SHADOWS_AA = 0
--- Draws a blurred rounded rectangle (frosted glass effect)
-- @param x number X position
-- @param y number Y position
-- @param w number Width
-- @param h number Height
-- @param flags number RNDX flags (must include RNDX.BLUR)
-- @param tl number Top-left corner radius
-- @param tr number Top-right corner radius
-- @param bl number Bottom-left corner radius
-- @param br number Bottom-right corner radius
-- @param thickness number Optional outline thickness
...
--- Draws a drop shadow with per-corner radii
-- @param x number X position
-- @param y number Y position
-- @param w number Width
-- @param h number Height
-- @param col Color Shadow color
-- @param flags number RNDX flags
...
-- @param spread number Shadow spread distance (default 30)
-- @param intensity number Shadow intensity (default spread * 1.2)
-- @param thickness number Optional outline thickness
...
--- Draws a drop shadow with uniform corner radius
-- @param r number Corner radius
-- @param x number X position
-- @param y number Y position
-- @param w number Width
-- @param h number Height
-- @param col Color Shadow color
-- @param spread number Shadow spread distance
...
-- Public flag constants for controlling corner visibility and shape
RNDX.NO_TL = NO_TL
RNDX.NO_TR = NO_TR
RNDX.NO_BL = NO_BL
RNDX.NO_BR = NO_BR
...
--- Sets or clears a flag on a flags bitmask
-- @param flags number Current flags bitmask
-- @param flag number|string Flag constant or name
-- @param bool boolean True to set, false to clear
-- @return number Updated flags bitmask
...
-- Make RNDX accessible via the LYXUI namespace
LYXUI.RNDX = RNDX
